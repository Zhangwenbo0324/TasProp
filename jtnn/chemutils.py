...
def get_smiles(mol):
    ...
    # try:
    #     s = Chem.MolToSmiles(mol,isomericSmiles=True, kekuleSmiles=True)
    # except:
    #     s = Chem.MolToSmiles(mol,isomericSmiles=True, kekuleSmiles=False)
    return s
...
def sanitize(mol):
    assert mol is not None, 'mol should not be NoneType.'
    try:
...
def get_clique_mol(mol, atoms):
    ...
    # if new_mol is None:
    #     print(smiles)
    # assert new_mol is not None, 'new_mol should not be NoneType.'
    return new_mol
